...
public class MainPage extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnSteps = v.findViewById(R.id.btnSteps);
        btnSteps.setOnClickListener(this);
        Button btnWeight = v.findViewById(R.id.btnWeight);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btnSteps){
            Navigation.findNavController(view).navigate(R.id.profile_to_steps);
        } else if (view.getId() == R.id.btnWeight){
            Navigation.findNavController(view).navigate(R.id.profile_to_weight);
        }
    }
